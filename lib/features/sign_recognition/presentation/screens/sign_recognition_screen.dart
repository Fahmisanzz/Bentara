              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      const Text('AI DEBUG INFO', style: TextStyle(color: AppColors.primary, fontSize: 10, fontWeight: FontWeight.bold)),
                      const SizedBox(height: 4),
                      const Text('Model: MediaPipe + LSTM (2 Tangan)', style: TextStyle(color: Colors.white70, fontSize: 9)),
                      Text('Tangan: ${state.debugInfo!.handsDetected}/2 (Kiri: ${state.debugInfo!.leftHandDetected ? "Ya" : "Tidak"}, Kanan: ${state.debugInfo!.rightHandDetected ? "Ya" : "Tidak"})', style: TextStyle(color: state.debugInfo!.handsDetected > 0 ? AppColors.successGreen : Colors.white70, fontSize: 10)),
                      Text('Fitur/Frame: ${state.debugInfo!.featureCount} floats', style: const TextStyle(color: Colors.white70, fontSize: 9)),
                      ...
                      if (state.debugInfo!.previewImage != null) ...[
                        const SizedBox(height: 8),
                        const Text('Kamera yang dilihat AI:', style: TextStyle(color: AppColors.primary, fontSize: 9)),
                        const SizedBox(height: 4),
                        Container(
                          width: 100,
                          height: 100,
